...
```sh
docker-compose up -d
docker exec flaskblog_postgre_server_1 psql -d postgres -U postgres  -f data_sql/backupdatabase.sql
```
...
pg_dump -c -U postgres postgres > data_sql/backupdatabase.sql
exit
git add data_sql/*
